  ...
  context "permissions" do
    describe "#create" do
      ...
      it 'create a post if the user is logged in' do
        ...
        expect { post :create, { :auction => attributes_for(:auction) }}.to change { Auction.all.count }.by(1)
      end

      it "should not create a post if the user is not logged in" do
        post :create, { :auction => attributes_for(:auction) }.to change { Auction.all.count }
